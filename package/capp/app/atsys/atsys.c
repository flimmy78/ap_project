...
#define FILE_LOCK           "/tmp/.atsys.lock"
...
__rsync(int idx, at_version_t *version)
{
    ...
    os_strdcpy(new, at_version_itoa(version));
    os_strdcpy(old, at_rootfs_version_string(idx));
...
__rcopy(int dst, char *dir, char *version)
{
    ...
    os_strdcpy(old, at_rootfs_version_string(dst));
