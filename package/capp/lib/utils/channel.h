...
static inline int
__ch_align(channel_t *ch, unsigned int number)
{
    return number & (ch->limit - 1);
}
...
__ch_buffer(channel_t *ch, unsigned int idx)
{
...
static inline bool
__ch_is_writeable(channel_t *ch, unsigned int idx)
{
    unsigned int reader = ch->reader;
    unsigned int writer = ch->writer;
...
static inline bool
__ch_is_readable(channel_t *ch, unsigned int idx)
{
    return false==__ch_is_writeable(ch, idx);
}

static inline int
__ch_SIZE(unsigned int type, unsigned int size)
{
    switch(type) {
        case CHANNEL_OBJECT:
            if (size <= 0) {
...
__ch_new(unsigned int type, unsigned int limit, unsigned int size)
{
    if (0==size) {
...
static inline int
__ch_get(channel_t *ch, unsigned int idx, void *obj)
{
    idx = __ch_align(ch, idx);
...
static inline int
__ch_set(channel_t *ch, unsigned int idx, void *obj)
{
    idx = __ch_align(ch, idx);
...
static inline bool
os_ch_is_writeable(channel_t *ch, unsigned int idx)
{
    if (NULL==ch) {
        /*
        * NULL as full
...
static inline bool
os_ch_is_readable(channel_t *ch, unsigned int idx)
{
    if (NULL==ch) {
        /*
        * NULL as full
...
static inline channel_t *
os_ch_new(unsigned int type, unsigned int limit, unsigned int size)
{
...
static inline int
os_ch_get(channel_t *ch, unsigned int idx, void *obj)
{
    if (NULL==ch) {
...
static inline int
os_ch_set(channel_t *ch, unsigned int idx, void *obj)
{
    if (NULL==ch) {
        return os_assertV(-EKEYBAD);
    } else if (NULL==obj) {
...
static inline int
os_8ch_get(channel_t *ch, unsigned int idx, uint8_t *pv)
{
    return os_ch_get(ch, idx, pv);
}

static inline int
os_8ch_set(channel_t *ch, unsigned int idx, uint8_t v)
{
...
static inline int
os_16ch_get(channel_t *ch, unsigned int idx, uint16_t *pv)
{
    return os_ch_get(ch, idx, pv);
}

static inline int
os_16ch_set(channel_t *ch, unsigned int idx, uint16_t v)
{
    return os_ch_set(ch, idx, &v);
}
...
static inline int
os_32ch_get(channel_t *ch, unsigned int idx, uint32_t *pv)
{
    return os_ch_get(ch, idx, pv);
}

static inline int
os_32ch_set(channel_t *ch, unsigned int idx, uint32_t v)
{
    return os_ch_set(ch, idx, &v);
}
...
static inline int
os_64ch_get(channel_t *ch, unsigned int idx, uint64_t *pv)
{
    return os_ch_get(ch, idx, pv);
}

static inline int
os_64ch_set(channel_t *ch, unsigned int idx, uint64_t v)
{
    return os_ch_set(ch, idx, &v);
}
...
static inline int
os_pch_get(channel_t *ch, unsigned int idx, void **pointer)
{
    return os_ch_get(ch, idx, (void *)pointer);
}

static inline int
os_pch_set(channel_t *ch, unsigned int idx, void *pointer)
{
