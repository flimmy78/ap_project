...
enum {
    ...
    __debug_level_io        = (1<<4),   /* IO   */
    __debug_level_timer     = (1<<5),   /* 定时器 */
    __debug_level_timeout   = (1<<6),   /* 超时 */
    __debug_level_event     = (1<<7),   /* 事件 */
    __debug_level_entry     = (1<<8),   /* 表项 */
    __debug_level_packet    = (1<<9),   /* 报文 */
    __debug_level_signal    = (1<<10),  /* 信号 */
    __debug_level_shell     = (1<<11),  /* system/popen */
    __debug_level_test      = (1<<12),  /* 测试 */
    __debug_level_consume   = (1<<13),  /* 计算cpu消耗 */
};
...
#define __debug_level_maps { \
    ...
    OS_KV_INITER("io",      __debug_level_io),      \
    OS_KV_INITER("timer",   __debug_level_timer),   \
...
#define __is_debug_level_io         __is_debug_level(__debug_level_io)
#define __is_debug_level_timer      __is_debug_level(__debug_level_timer)
...
#define __vdebug_io(_fmt, _args)        __jvdlogger(jlog_vprintf, __debug_level_io, _fmt, _args)
#define __vdebug_timer(_fmt, _args)     __jvdlogger(jlog_vprintf, __debug_level_timer, _fmt, _args)
...
#define __debug_io(_fmt, _args...)      __jdlogger(jlog_printf, __debug_level_io, _fmt, ##_args)
#define __debug_timer(_fmt, _args...)   __jdlogger(jlog_printf, __debug_level_timer, _fmt, ##_args)
...
#define vdebug_io(_fmt, _args)          jvdlogger(__debug_level_io, _fmt, _args)
#define vdebug_timer(_fmt, _args)       jvdlogger(__debug_level_timer, _fmt, _args)
...
#define debug_io(_fmt, _args...)        jdlogger(__debug_level_io, _fmt, ##_args)
#define debug_timer(_fmt, _args...)     jdlogger(__debug_level_timer, _fmt, ##_args)
