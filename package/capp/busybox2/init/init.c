...
static struct init_action startup = {
    .command    = "sysstartup",
    .terminal   = "",
...
static struct init_action atdog = {
    .command    = "/bin/atdog disable",
    .terminal   = "",
    .action_type= ONCE | STATICACT,
    .next       = &startup,
};
...
static struct init_action atcheck = {
    .command    = "/bin/atcheck",
    .terminal   = "",
    .action_type= ONCE | STATICACT,
    .next       = &lastrc,
...
static struct init_action rtsyncd = {
    .command    = "/etc/rtsync/rtsyncd",
    .terminal   = "",
    .action_type= RESPAWN | STATICACT,
    .next       = &atcheck,
};

static struct init_action get_3g_state = {
	.command    = "/usr/sbin/get_3g_state.sh",
	.terminal   = "",
	.action_type= RESPAWN | STATICACT,
	.next       = &rtsyncd,
};

static struct init_action connect_3g = {
	.command    = "/usr/sbin/3g_connect.sh",
	.terminal   = "",
	.action_type= RESPAWN | STATICACT,
	.next       = &get_3g_state,
};
