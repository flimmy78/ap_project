...
#if 1 /* AUTELAN */
IF_APPKEY(APPLET(appkey, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
...
#if 1 /* AUTELAN*/
IF_AT_TTYUSB0(APPLET(at_ttyUSB0, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
IF_AT_TTYUSB1(APPLET(at_ttyUSB1, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
IF_AT_TTYUSB3(APPLET(at_ttyUSB3, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
#endif
#if 1 /* AUTELAN */
IF_ATCHECK(APPLET(atcheck, _BB_DIR_BIN, _BB_SUID_DROP))
IF_ATCOOKIE(APPLET(atcookie, _BB_DIR_BIN, _BB_SUID_DROP))
IF_ATDOG(APPLET(atdog, _BB_DIR_BIN, _BB_SUID_DROP))
IF_ATENV(APPLET(atenv, _BB_DIR_BIN, _BB_SUID_DROP))
IF_ATOTP(APPLET(atotp, _BB_DIR_BIN, _BB_SUID_DROP))
IF_ATRT(APPLET(atrt, _BB_DIR_BIN, _BB_SUID_DROP))
IF_ATSS(APPLET(atss, _BB_DIR_BIN, _BB_SUID_DROP))
IF_ATSYS(APPLET(atsys, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
...
#if 1 /* AUTELAN */
IF_SINETD(APPLET(sinetd, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
IF_SLATTACH(APPLET(slattach, _BB_DIR_SBIN, _BB_SUID_DROP))
IF_SLEEP(APPLET_NOFORK(sleep, sleep, _BB_DIR_BIN, _BB_SUID_DROP, sleep))
#if 1 /* AUTELAN */
IF_SMONITORC(APPLET(smonitorc, _BB_DIR_BIN, _BB_SUID_DROP))
IF_SMONITORD(APPLET(smonitord, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
...
#if 1 /* AUTELAN */
IF_STIMERC(APPLET(stimerc, _BB_DIR_BIN, _BB_SUID_DROP))
IF_STIMERD(APPLET(stimerd, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
...
IF_UMC(APPLET(umd, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
